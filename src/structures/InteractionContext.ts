...
export class InteractionContext<GuildOnly extends boolean = false> {
     ...
     */
    public readonly guildId: GuildOnly extends true ? Snowflake : Snowflake | undefined;
    /**
     * The guild's preferred locale, if the interaction was invoked in a guild.
     */
    public readonly guildLocale: GuildOnly extends true ? DiscordTypes.LocaleString : DiscordTypes.LocaleString | undefined;
    /**
     * Interaction data.
     */
     ...
     */
    public readonly member: GuildOnly extends true ? DiscordTypes.APIInteractionGuildMember : DiscordTypes.APIInteractionGuildMember | undefined;
    /**
     * The permissions the bot has in the channel the interaction was invoked in.
     */
    public readonly permissions: GuildOnly extends true ? bigint : bigint | undefined;
    /**
     * The invoking user.
     */
    public readonly user: DiscordTypes.APIUser & { locale: Required<DiscordTypes.APIUser>[`locale`] };
     ...
     */
    public async send (message: FactoryMessage, components?: FactoryComponents): Promise<`@original` | Snowflake> {
     ...
     * @returns The ID of the created message, or `@original`.
     */
    public async sendEphemeral (message: FactoryMessage, components?: FactoryComponents): Promise<`@original` | Snowflake> {
        const factoryMessage = messageFactory(message, components);
     ...
     */
    public async edit (id: `@original` | Snowflake, message: FactoryMessage, components?: FactoryComponents): Promise<DiscordTypes.RESTPatchAPIInteractionFollowupResult> {
        const factoryMessage = messageFactory(message, components);
