...
export class Button extends BaseComponent<DiscordTypes.APIButtonComponentWithCustomId> {
    declare setExecute: (executeCallback: BaseComponentContextCallback<ButtonContext>) => this;
...
export class ButtonContext extends BaseComponentContext {
     ...
     */
    constructor (interaction: DiscordTypes.APIMessageComponentButtonInteraction, commandHandler: CommandHandler) { // eslint-disable-line no-useless-constructor
