 ...
 */
export class StringSelect<Options extends string[] = []> extends BaseSelect<DiscordTypes.ComponentType.StringSelect> {
    declare setExecute: (executeCallback: BaseComponentContextCallback<StringSelectContext<Options>>) => this;
    declare getExecute: () => BaseComponentContextCallback<StringSelectContext<Options>>;
    declare protected _execute: BaseComponentContextCallback<StringSelectContext<Options>>;
     ...
     */
    public addOption <T extends string> (label: string, value: T, description?: string, emoji?: DiscordTypes.APIMessageComponentEmoji, defaultOption?: boolean): StringSelect<Array<Options[number] | T>> {
        this._raw.options ??= [];
 ...
 */
export class StringSelectContext<Options extends string[] = []> extends BaseComponentContext {
    /**
