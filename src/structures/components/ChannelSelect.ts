...
export class ChannelSelect extends BaseSelect<DiscordTypes.ComponentType.ChannelSelect> {
  declare setExecute: (
    executeCallback: BaseComponentContextCallback<ChannelSelectContext>,
  ) => this;
  ...
  public setChannelTypes(
    ...types: Array<ChannelSelectTypes | DiscordTypes.ChannelType>
  ): this {
...
export class ChannelSelectContext extends BaseComponentContext {
   ...
   */
  constructor(
    interaction: SelectInteraction<DiscordTypes.ComponentType.ChannelSelect>,
