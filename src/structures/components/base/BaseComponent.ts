...
export abstract class BaseComponent<
  Raw extends
    | DiscordTypes.APIButtonComponentWithCustomId
    | DiscordTypes.APISelectMenuComponent,
> {
  /**
...
export abstract class BaseComponentContext extends InteractionContext {
   ...
   */
  constructor(
    interaction: DiscordTypes.APIMessageComponentInteraction,
