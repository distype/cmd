 ...
 * @internal
 */
export type SelectInteraction<T extends DiscordTypes.APISelectMenuComponent[`type`]> = DiscordTypes.APIBaseInteraction<DiscordTypes.InteractionType.MessageComponent, Extract<DiscordTypes.APIMessageSelectMenuInteractionData, { component_type: T }>> & Required<Pick<DiscordTypes.APIBaseInteraction<DiscordTypes.InteractionType.MessageComponent, Extract<DiscordTypes.APIMessageSelectMenuInteractionData, { component_type: T }>>, `channel_id` | `data` | `message`>>;
 ...
 * @internal
 */
export class BaseSelect<T extends DiscordTypes.APISelectMenuComponent[`type`]> extends BaseComponent<Extract<DiscordTypes.APISelectMenuComponent, { type: T }> > {
    /**
