 ...
 */
export class UserCommand<GuildOnly extends boolean = false> extends BaseCommand<DiscordTypes.RESTPostAPIContextMenuApplicationCommandsJSONBody> {
    declare setGuild: (id: string) => UserCommand<true>;
    declare setGuildOnly: <T extends boolean>(guildOnly: T) => UserCommand<T>;
    declare setExecute: (executeCallback: BaseCommandContextCallback<UserCommandContext<GuildOnly>>) => this;
    declare getExecute: () => BaseCommandContextCallback<UserCommandContext<GuildOnly>>;
    declare protected _execute: BaseCommandContextCallback<UserCommandContext<GuildOnly>>;
 ...
 */
export class UserCommandContext<GuildOnly extends boolean = false> extends BaseCommandContext<GuildOnly> {
    /**
    ...
    constructor (interaction: DiscordTypes.APIUserApplicationCommandInteraction, commandHandler: CommandHandler) {
        ...
        this.target = {
            ...
            member: interaction.data.resolved.members?.[interaction.data.target_id] as any
        };
