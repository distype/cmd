...
import { RemoveDeprecated, sanitizeCommand, SanitizedCommand, sanitizeGuildCommand } from '../../../utils/sanitizeCommand';
 ...
 * @internal
 */
export abstract class BaseCommand<Raw extends DiscordTypes.RESTPostAPIApplicationCommandsJSONBody> {
    /**
     ...
     * The raw command.
     */
    protected _raw: Partial<Omit<RemoveDeprecated<Raw>, `type`>> & { type: Required<Raw>[`type`] };
     ...
     * @returns The command.
     */
    public setName (name: string, localization?: DiscordTypes.LocalizationMap): this {
        this._raw.name = name;
     ...
     * @returns The command.
     */
    public setDefaultMemberPermissions (...permissions: Parameters<typeof PermissionsUtils.combine>): this {
        this._raw.default_member_permissions = PermissionsUtils.combine(...permissions).toString();
        return this;
    }
     ...
     * @returns The command.
     */
    public setGuildOnly <T extends boolean> (guildOnly: T): BaseCommand<Raw> {
 ...
 * @internal
 */
export abstract class BaseCommandContext<GuildOnly extends boolean> extends InteractionContext<GuildOnly> {
    /**
     * Command data.
     */
