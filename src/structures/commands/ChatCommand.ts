...
> = ChatCommand<
  GuildOnly,
  Options & { [key in K]: R extends true ? T : T | undefined }
>;
...
> extends BaseCommand<DiscordTypes.RESTPostAPIChatInputApplicationCommandsJSONBody> {
  declare setGuild: (id: string) => ChatCommand<true, Options>;
  declare setGuildOnly: () => ChatCommand<true, Options>;
  declare setExecute: (
    executeCallback: BaseCommandContextCallback<
      ChatCommandContext<GuildOnly, Options>
    >,
  ) => this;
   ...
   * @returns The command.
   */
  public addStringOption<R extends boolean, K extends string>(
    required: R,
    name: K,
    description: string,
    options?: ChatCommandBaseOptionOptions & {
   ...
   * @returns The command.
   */
  public addIntegerOption<R extends boolean, K extends string>(
    required: R,
    name: K,
    description: string,
    options?: ChatCommandBaseOptionOptions & {
   ...
   * @returns The command.
   */
  public addBooleanOption<R extends boolean, K extends string>(
    required: R,
    name: K,
    description: string,
    options?: ChatCommandBaseOptionOptions,
  ): AddOption<boolean, R, K, GuildOnly, Options> {
    this._raw.options ??= [];
    this._raw.options.push({
      description,
      name,
   ...
   * @returns The command.
   */
  public addUserOption<R extends boolean, K extends string>(
    required: R,
    name: K,
    description: string,
    options?: ChatCommandBaseOptionOptions,
   ...
   * @returns The command.
   */
  public addChannelOption<R extends boolean, K extends string>(
    required: R,
    name: K,
    description: string,
    options?: ChatCommandBaseOptionOptions & {
    ...
    DiscordTypes.APIInteractionDataResolvedChannel,
    R,
    K,
    GuildOnly,
    Options
   ...
   * @returns The command.
   */
  public addRoleOption<R extends boolean, K extends string>(
    required: R,
    name: K,
    description: string,
    options?: ChatCommandBaseOptionOptions,
  ): AddOption<DiscordTypes.APIRole, R, K, GuildOnly, Options> {
    this._raw.options ??= [];
    this._raw.options.push({
      description,
      name,
   ...
   * @returns The command.
   */
  public addMentionableOption<R extends boolean, K extends string>(
    required: R,
    name: K,
    description: string,
    options?: ChatCommandBaseOptionOptions,
   ...
   * @returns The command.
   */
  public addNumberOption<R extends boolean, K extends string>(
    required: R,
    name: K,
    description: string,
    options?: ChatCommandBaseOptionOptions & {
   ...
   * @returns The command.
   */
  public addAttachmentOption<R extends boolean, K extends string>(
    required: R,
    name: K,
    description: string,
    options?: ChatCommandBaseOptionOptions,
  ): AddOption<DiscordTypes.APIAttachment, R, K, GuildOnly, Options> {
    this._raw.options ??= [];
    this._raw.options.push({
      description,
      name,
...
> extends BaseCommandContext<GuildOnly> {
   ...
   */
  constructor(
    interaction: DiscordTypes.APIChatInputApplicationCommandInteraction,
