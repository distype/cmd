...
export declare class Button {
     ...
     * @internal
     */
    runExecuteExpire: ((ctx: ButtonExpireContext) => (boolean | Promise<boolean>)) | null;
    /**
     * The raw button.
     */
    private _raw;
 ...
 */
export declare class ButtonExpireContext extends BaseComponentExpireContext {
    /**
